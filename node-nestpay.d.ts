...
export interface INestSecure3dPayHostingRequestReturn {
  form: {
    clientId: string;
    oid: string;
    amount: string;
...
export default class NestPay {
  ...
  public secure3d(
    options: INestSecure3dRequest
  ): Promise<INestSecure3dRequestReturn | string>;

  public secure3dpayhosting(
    options: INestSecure3dRequest
  ): Promise<INestSecure3dPayHostingRequestReturn | string>;
